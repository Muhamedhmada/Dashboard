      ...
      <form action=''>
        <div>
          ...
          <div className='specialInput'>
            ...
            <input type='text' value={data?.app_name["en"]} />
          </div>
          <div className='specialInput'>
            <label>{t("website_name_espain")}</label>
            <input type='text' value={data?.app_name["de"]} />
          </div>
          <div className='specialInput'>
            <label>{t("website_name_arabic")}</label>
            <input type='text' value={data?.app_name["ar"]} />
          </div>
        </div>
        <div>
          ...
          <div className='specialInput'>
            ...
            <input type='text' value={data?.app_description["en"]} />
          </div>
          <div className='specialInput'>
            <label>{t("website_desc_espain")}</label>
            <input type='text' value={data?.app_description["de"]} />
          </div>
          <div className='specialInput'>
            <label>{t("website_desc_arabic")}</label>
            <input type='text' value={data?.app_description["ar"]} />
          </div>
        </div>
      </form>
